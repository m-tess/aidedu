...
<!--close-top-search-->
	...
	<div id="sidebar">
		...
		<ul>
					...
					<!-- Par numId -->
					<li class="active"><a href="Frequentation.jsp"><i class="icon icon-file"></i><span>Etablissements fréquentés</span></a></li>
		...
		<h3>Recherche d'inscriptions d'un élève :</h3>
			...
			<div class="row-fluid">
				<form action="login2" method="post">
					...
					<span class="pull-left"><input typ#e="text"
						placeholder="NIN Elève" minlength="9" maxlength="9" name="numId" value="${model.numId}" /></span>
